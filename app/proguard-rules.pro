...
# Firebase Components — registrars are looked up via reflection / service loader.
# Without these keep rules, R8 strips the Crashlytics ComponentRegistrar (and any
# other Firebase library that uses the components SDK), and the app crashes at
# startup with "FirebaseCrashlytics component is not present". Símaver beta35
# shipped this regression — CrashlyticsTree is the runtime guard, this is the
# build-time guard.
